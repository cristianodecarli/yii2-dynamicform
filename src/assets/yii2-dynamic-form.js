 ...
 * @contributor Cristiano de Carli <cristianodecarli@gmail.com>
 */
(function ($) {
    ...
    var _restoreSpecialJs = function (widgetOptions) {
        ...
        if ($hasSpectrum.length > 0) {
            $hasSpectrum.each(function () {
                ...
                jQuery.when(jQuery(id).spectrum(spectrum)).done(function () {
                    jQuery(id).spectrum('set', jQuery(matches[1] + matches[2] + "color").val());
